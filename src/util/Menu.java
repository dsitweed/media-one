...
public class Menu {
    ...
    static public void staffMenu() {
        ...
        while (true) {
            ...
            System.out.println("2. Thêm phí phát sinh");
...
//      Cần  sửa thành tìm tới Staff đang đăng nhập và nhập thông tin khách hàng
    ...
    static public void manageStaffs() {
        ...
        while (option != 6) {
            ...
            switch (option) {
                case 1:
                    name = IO.getString(scanner, "", "Tên nhân viên: ");
                ...
                case 4:
                    ...
                    break;
                case 5:
                    name = IO.getString(scanner, "", "Tên nhân viên muốn xóa: ");
                    List<Staff> list = warehouse.findStaffByName(name);
                    warehouse.showListStaff(list);
                    index = IO.getNumberIndex(scanner, "Index của nhân viên: ");
                    warehouse.removeStaff(list.get(index));
                    break;
                case 6:
                    break;
                default:
