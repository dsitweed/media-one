...
public class Product implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return quantity == product.quantity && Double.compare(product.sellPrice, sellPrice) == 0 && Double.compare(product.importPrice, importPrice) == 0 && Objects.equals(code, product.code) && Objects.equals(name, product.name);
    }
